...
<body>
  ...
  <center>
    ...
    <br>
    <a href='../Radio bulbul/Agriculture/agriculture_drama/$name'>$name</a>
    ...
    // Opens directory
    //$myDirectory=opendir("././Agriculture/agriculture_drama/");

    // Gets each entry
    //while($entryName=readdir($myDirectory)) {
    // $dirArray[]=$entryName;
    //}
    $dirArray = glob("./Agriculture/agriculture_talkshows/*");
    ...
    for ($index = 0; $index < $indexCount; $index++) {
	  ...
	  <audio autoplay id='audio' preload='auto' tabindex= '0' controls='' type='audio/mpeg'>
           <source src='./Agriculture/agriculture_talkshows/$name'>
	  ...
	  <ul id='playlist'>
           ...
           <li class='active'>
 	    <a href=../Radio bulbul/Agriculture/agriculture_talkshows/$name'>$name</a>
       <div>
