...
<body>
  ...
  <center>
    ...
    // $dirArray[]=$entryName;
    //}
    $dirArray = glob("./Special days/specialdays_national/*");
    ...
    for ($index = 0; $index < $indexCount; $index++) {
	  ...
	  <audio autoplay id='audio' preload='auto' tabindex= '0' controls='' type='audio/mpeg'>
           <source src='./Special days/specialdays_national/$name'>
	  ...
	  <ul id='playlist'>
           ...
           <li class='active'>
 	    <a href=../Radio bulbul/Special days/specialdays_national/$name'>$name</a>
       <div>
