...
def sync(catname,ipmap,logger):
    for i in ipmap:
        try:
            os.system("sshpass -f '/home/pi/Documents/Namdu1Radio/sshpass' rsync -azP -e 'ssh -o StrictHostKeyChecking=no' /var/www/html/.upload/"+catname+"/ pi@"+i+":/var/www/html/.upload/"+catname+" --ignore-existing")
